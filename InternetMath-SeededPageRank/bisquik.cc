...
typedef int64_t VertexType; // vertex type is a numeric type
typedef int64_t EdgeType; // edge should index an array
 ...
 */
extern "C" int check_graphical_sequence(
    VertexType nverts,
    VertexType* degrees)
{
...
extern "C" int64_t testing_function(int64_t a, int64_t b)
{
    return a+b;
}

extern "C" int generate_bisquik_graph(int64_t n, int64_t *degrees, int64_t *src, int64_t *dstn)
{
 ...
 */
extern "C" int generate_samples(const char* filename, std::vector<VertexType>& degrees)
{
